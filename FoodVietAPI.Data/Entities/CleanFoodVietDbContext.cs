    ...
    public partial class CleanFoodVietDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Appointment>(entity =>
            {
                ...
                entity.Property(e => e.CreatedAt).HasColumnType("datetime");
                entity.Property(e => e.UpdatedAt).HasColumnType("datetime");
                entity.Property(e => e.ActionedBy).HasMaxLength(150);
                entity.Property(e => e.ActionReason).HasMaxLength(255);
            ...
            modelBuilder.Entity<OrderDeliveryDetail>(entity =>
            {
                ...
                entity.HasIndex(e => e.OrderDetailId).HasDatabaseName("IX_OrderDeliveryDetail_OrderDetailId");
                ...
                entity.HasOne(e => e.OrderDetail)
                      ...
                      .OnDelete(DeleteBehavior.Restrict)
                      .HasConstraintName("FK_OrderDeliveryDetail_OrderDetail");
            });
