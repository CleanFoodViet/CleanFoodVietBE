...
namespace CleanFoodVietAPI.Presentation.Controllers
{
    ...
    public class ProductCategoryController : BaseController<ProductCategoryController>
    {
        ...
        {
            await _productCategoryService.CreateProductCategory(categoryData);

            return Ok("Create product category successfully");
        }
        ...
        {
            await _productCategoryService.UpdateProductCategory(id, updateData);

            return Ok("Update product category successfully");
        }
